            ...
            <Columns>
              ...
              >
                <QuickAndDirtyCapRate
                  ...
                  expenseRateHandleInputChange={this.handleInputChange('expenseRate')}
                  rent={this.state.rent}
                  rentHandleInputChange={this.handleInputChange('rent')}
                  vacancyRate={this.state.vacancyRate}
                  vacancyRateHandleInputChange={this.handleInputChange('vacancyRate')}
                />
              </Column>
            </Columns>
          </Container>
